// FIXME this file may be deleted or refactored/renamed/moved as need be
//  place holder here for v2 impl reference for use case & view requirement
//  logic if anything useful
